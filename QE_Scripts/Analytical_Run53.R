...
################################################################################
#### Functions
Perform_Analytical_Run53 <- function(f.flag = 1) {
    #### Function to perform analytical run 53 simulations
    ...
    ######### Main program
    source("Parameters/Analytical_Run53_Parameters.R")
    ...
    if (f.flag == 1) {
        ...
        tiff("Plots/Analytical_Run53_2d.tiff",
