...
################################################################################
#### Functions
Perform_Analytical_Run82 <- function(f.flag = 1) {
    #### Function to perform analytical run 82 simulations
    ...
    ######### Main program
    source("Parameters/Analytical_Run82_Parameters.R")
    ...
    if (f.flag == 1) {
        ...
        tiff("Plots/Analytical_Run82_2d.tiff",
