...
################################################################################
#### Functions
Perform_Analytical_Run81 <- function(f.flag = 1) {
    #### Function to perform analytical run 8 simulations
    ...
    ######### Main program
    source("Parameters/Analytical_Run81_Parameters.R")
    ...
    if (f.flag == 1) {
        ...
        tiff("Plots/Analytical_Run81_2d.tiff",
