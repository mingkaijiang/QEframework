...
################################################################################
#### Functions
Perform_Analytical_Run27 <- function(f.flag = 1) {
    #### Function to perform analytical run 27 simulations
    ...
    ######### Main program
    source("Parameters/Analytical_Run27_Parameters.R")
    ...
    L <- L_constraint_Medlyn_Dewar_linear_coupling(a=a_nf)
    
    ### Find long term equilibrium point
    L_eq <- solve_L_Medlyn_Dewar_linear_coupling_new(CO2=CO2_1)
    ...
    ### Find long term equilibrium point
    L_eq <- solve_L_Medlyn_Dewar_linear_coupling_new(CO2=CO2_2)
