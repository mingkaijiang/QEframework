...
################################################################################
#### Functions
Perform_Analytical_Run70 <- function(f.flag = 1) {
    #### Function to perform analytical run 70 simulations
    ...
    if (f.flag == 1) {
        ...
        tiff("Plots/Analytical_Run70_2d.tiff",
