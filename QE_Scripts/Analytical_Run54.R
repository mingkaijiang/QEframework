...
################################################################################
#### Functions
Perform_Analytical_Run54 <- function(f.flag = 1) {
    #### Function to perform analytical run 54 simulations
    ...
    ######### Main program
    source("Parameters/Analytical_Run54_Parameters.R")
    ...
    if (f.flag == 1) {
        ...
        tiff("Plots/Analytical_Run54_2d.tiff",
