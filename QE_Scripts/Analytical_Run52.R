...
################################################################################
#### Functions
Perform_Analytical_Run52 <- function(f.flag = 1) {
    #### Function to perform analytical run 52 simulations
    ...
    ######### Main program
    source("Parameters/Analytical_Run52_Parameters.R")
    ...
    if (f.flag == 1) {
        ...
        tiff("Plots/Analytical_Run52_2d.tiff",
