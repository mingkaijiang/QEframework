...
################################################################################
#### Functions
Perform_Analytical_Run83 <- function(f.flag = 1) {
    #### Function to perform analytical run 83 simulations
    ...
    ######### Main program
    source("Parameters/Analytical_Run83_Parameters.R")
    ...
    if (f.flag == 1) {
        ...
        tiff("Plots/Analytical_Run83_2d.tiff",
