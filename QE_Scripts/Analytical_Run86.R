...
################################################################################
#### Functions
Perform_Analytical_Run86 <- function(f.flag = 1) {
    #### Function to perform analytical run 86 simulations
    ...
    ######### Main program
    source("Parameters/Analytical_Run86_Parameters.R")
    ...
    if (f.flag == 1) {
        ...
        tiff("Plots/Analytical_Run86_2d.tiff",
