...
################################################################################
#### Functions
Perform_Analytical_Run84 <- function(f.flag = 1) {
    #### Function to perform analytical run 84 simulations
    ...
    ######### Main program
    source("Parameters/Analytical_Run84_Parameters.R")
    ...
    if (f.flag == 1) {
        ...
        tiff("Plots/Analytical_Run84_2d.tiff",
