...
make_summary_table <- function(destDir) {
    ...
    out.tab[12,"NPP_350"] <- round(r11$eDF$NPP_act_VL[1],2)
    out.tab[12,"NPP_700"] <-  round(r11$eDF$NPP_act_VL[2],2)
    out.tab[12,"I"] <- round((r11$eDF$NPP_I[2] - r11$eDF$NPP_act_VL[1]) / r11$eDF$NPP_act_VL[1] * 100,2)
    out.tab[12,"M"] <- round((r11$eDF$NPP_act_M[2] - r11$eDF$NPP_act_VL[1]) / r11$eDF$NPP_act_VL[1] * 100,2)
    out.tab[12,"L"] <- round((r11$eDF$NPP_act_L[2] - r11$eDF$NPP_act_VL[1]) / r11$eDF$NPP_act_VL[1] * 100,2)
    out.tab[12,"VL"] <- round((r11$eDF$NPP_act_VL[2] - r11$eDF$NPP_act_VL[1]) / r11$eDF$NPP_act_VL[1] * 100,2)
    
    ### Run 12 C cost of N uptake, variable wood
    out.tab[11,"NPP_350"] <- round(r12$eDF$NPP_act_VL[1],2)
    out.tab[11,"NPP_700"] <-  round(r12$eDF$NPP_act_VL[2],2)
    out.tab[11,"I"] <- round((r12$eDF$NPP_I[2] - r12$eDF$NPP_act_VL[1]) / r12$eDF$NPP_act_VL[1] * 100,2)
    out.tab[11,"M"] <- round((r12$eDF$NPP_act_M[2] - r12$eDF$NPP_act_VL[1]) / r12$eDF$NPP_act_VL[1] * 100,2)
    out.tab[11,"L"] <- round((r12$eDF$NPP_act_L[2] - r12$eDF$NPP_act_VL[1]) / r12$eDF$NPP_act_VL[1] * 100,2)
    out.tab[11,"VL"] <- round((r12$eDF$NPP_act_VL[2] - r12$eDF$NPP_act_VL[1]) / r12$eDF$NPP_act_VL[1] * 100,2)
