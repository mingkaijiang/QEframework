#### Functions
P_limitation_effect_AmazonFACE <- function() {
    ...
    source("Parameters/Analytical_Run2_Parameters_AmazonFACE.R")
    ...
    #### Plotting
    tiff("Plots/Effect_of_P_limitation_AmazonFACE.tiff",
    ...
    #### Plotting
    tiff("Plots/Effect_of_P_limitation_on_CO2_fertilization_AmazonFACE.tiff",
         width = 8, height = 7, units = "in", res = 300)
    par(mar=c(5.1,6.1,2.1,2.1))
...
#### Program
P_limitation_effect_AmazonFACE()
