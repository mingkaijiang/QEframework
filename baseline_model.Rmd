...
``` {r, echo=FALSE, warning=F, message=F}
    ...
    ### plot
    p<-ggplot() + 
        geom_line(data=cdf1.r7, aes(x=nc, y=NUE, col="NUE trajectory"), size=0.5, linetype="dotted") +   
...
``` {r, echo=FALSE, warning=F, message=F}
    ...
    ### plot
    p<-ggplot() + 
        geom_line(data=cdf1.r8, aes(x=nc, y=NUE, col="NUE trajectory"), size=0.5, linetype="dotted") +   
...
Below is a continuous update of the to-do list of this project:
    ...
    - Spell out all equations and derivations
    ...
    - Possibly submit to Biogeosciences or JGR: biogeosciences
