...
``` {r, message = FALSE}
    # baseline, variable wood NC, baseline N cycle model
    r1 <- Perform_Analytical_Run1(f.flag = 2)
    
    # baseline, fixed wood NC, baseline N cycle model
...
```{r, echo=FALSE, fig.width = 5, fig.align="center"}
    ...
    points(cdf1.r1$nc, cdf1.r1$NPP_VL, type="l", col="tomato", lwd = 3, add= T)
