...
<p align="center">
<img src="Model_framework.png" width = "400" height = "400">
</p>

The entire QE framework is built based on the model structure of the Generic Decomposition And Yield (G'DAY) model, as shown in the figure above. 
...
``` {r, echo = FALSE, fig.width = 7, fig.align="center", message = FALSE, warning = FALSE, results="hide"}
    ...
    p<-ggplot() + 
        ...
        geom_point(data=edf, aes(x=nc_L_700, y=NPP_L_700, fill="C"), 
                   shape=21, color="black", size=3) +
        geom_point(data=edf, aes(x=nc_VL_700, y=NPP_VL_700, fill="D"), 
                   shape=21, color="black", size=3) +
        ...
        scale_colour_manual(name="Constraint line", 
                            values = c("C350" = "darkblue", "C700" = cbbPalette[3], "VL" = "red",
                                       "L" = "orange", "M" = "purple")) +
        scale_fill_manual(name="QE point", values = c("A" = "green", "B" = "lightgreen", 
                                                      "C" = "orange", "D" = "red")) 
...
<p align="center">
<img src="Transient_behavior.png" width = "400" height = "400">
</p>
...
### C cost of N uptake - CLM approach
...
Below is a continuous update of the to-do list of this project:
    ...
    - Test CLM N uptake function (essentially it's the same as O-CN, with some additional parameters)
    - Test CLM and Ellsworth representation of photosynthesis
    - Test CLM representation of C cost of N uptake
    - Check parameter sensitivity for priming effect.
    - Consider different n uptake rate and graphically demonstrate its effect
    - Add equations for GDAY and O-CN representation of N uptake as function of mineral N and root biomass
    - Add graphic introduction (i.e. a previous QE framework figure)
    - Summary table comparing all model assumptions and their CO2 effect (% change)
